...
export class EventParser {
  ...
  // execution stack).
  private handleLog(execution: ExecutionContext, log: string): [Event | null, string | null, boolean] {
  ...
  private handleProgramLog(log: string): [Event | null, string | null, boolean] {
    // This is a `msg!` log.
