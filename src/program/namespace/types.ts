...
export type InstructionContextFn<IDL extends Idl, I extends AllInstructions<IDL>, Ret> = (
...
export type TypeDef<I extends IdlTypeDef, Defined> = {
  [F in FieldsOfType<I>['name']]: DecodeType<(FieldsOfType<I> & { name: F })['type'], Defined>;
};
...
export type IdlTypes<T extends Idl> = TypeDefDictionary<NonNullable<T['types']>, Record<string, never>>;

export type IdlAccounts<T extends Idl> = TypeDefDictionary<NonNullable<T['accounts']>, Record<string, never>>;
